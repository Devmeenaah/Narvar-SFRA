...
// The deliveryPromise code is included via alias; no per-cartridge src entries required.
...
module.exports = [
    {
        ...
        resolve: {
            alias: {
                'int_promise_delivery/deliveryPromise': path.resolve(
                    './cartridges/int_promise_delivery/cartridge/client/default/js/deliveryPromise/deliveryPromise.js'
                )
            }
        },
        output: {
